...
import ImputMoment from 'input-moment/dist/input-moment.css'
        ...
        return (
            <div>
                ...
                <h1>Criar corrida</h1>
                {
                    ...
                    <Segment color='green'>Corrida criada com sucesso! :D</Segment>
                }
                {!this.props.runs.saved &&
                    <Form>
                        <Form.Field>
                        ...
                        <Form.Field>
                            <label>Duraçāo em segundos:</label>
                        ...
                        <Form.Field>
                            <label>Criaçāo:</label>
                            <input type='text' value={this.state.created.format('DD/MM/YY H:mm:ss')} onChange={this.handleChange('created')} />
                        </Form.Field>
                        <InputMoment
